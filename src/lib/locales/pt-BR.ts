...
const dict: LocaleDict = {
  ...
  "app.config.maxParallelAgentsHint": "Quanto maior, mais rápido — porém consome mais do limite por hora. Quanto menor, mais lento, mas economiza o limite.",
  ...
  "app.config.contextRotRisk": "Risco de Context Rot",
  ...
  "app.config.updatesChecking": "Verificando…",
  "app.config.updatesUpToDate": "Você já está na última versão.",
  "app.config.updatesError": "Falha ao verificar atualizações: {0}",
  "update.available": "Nova versão {0} disponível",
  "update.installNow": "Atualizar agora",
  "update.later": "Depois",
  "update.downloading": "Baixando e instalando…",
  "update.error": "Falha ao atualizar: {0}",
  ...
  // ── Indicador de atividade de rede ────────────────────────────────
  "net.title": "Atividade de rede",
  "net.idle": "Sem atividade de rede",
  "net.lastOp": "Última: {0}",
  "net.source.llm_stream": "Resposta do modelo",
  "net.why.llm_stream": "Recebendo a resposta do modelo em streaming. Continua até o turno terminar — incluindo ciclos do golden loop e subagentes.",
  "net.source.llm_classify": "Verificação de fim de turno",
  "net.why.llm_classify": "Chamada curta ao modelo para verificar se a resposta do agente realmente terminou.",
  "net.source.llm_one_shot": "Chamada avulsa ao modelo",
  "net.why.llm_one_shot": "Requisição única ao modelo, sem streaming (melhoria de prompt, compactação, avaliação).",
  "net.source.list_models": "Lista de modelos",
  "net.why.list_models": "Buscando a lista de modelos disponíveis na API.",
  "net.source.auth": "Autenticação",
  "net.why.auth": "Fazendo login ou validando sua chave de API.",
  "net.source.provider_catalog": "Catálogo de provedores",
  "net.why.provider_catalog": "Baixando o catálogo de provedores do models.dev.",
  "net.source.skills_index": "Registro de skills",
  "net.why.skills_index": "Buscando o índice remoto de skills.",
  "net.source.skill_fetch": "Download de skill",
  "net.why.skill_fetch": "Baixando a definição de uma skill.",
  "net.source.embedding_model_download": "Download do modelo de embeddings",
  "net.why.embedding_model_download": "Baixando o modelo local de busca semântica (só quando ainda não está em cache).",
  "net.source.web_search": "Busca na web",
  ...
  // Provedores (Configurações › Conta)
  ...
  "settings.providers.openrouterDesc": "Acesse centenas de modelos com uma única conta, via OAuth.",
  "settings.providers.more": "Mais provedores…",
  // Modal do catálogo de provedores
  "providerCatalog.title": "Catálogo de provedores",
  "providerCatalog.search": "Buscar provedores…",
  "providerCatalog.pickProvider": "Escolha um provedor na lista para conectá-lo.",
  "providerCatalog.apiKey": "Chave de API",
  "providerCatalog.apiKeyPlaceholder": "Cole sua chave de API",
  "providerCatalog.baseUrl": "URL base",
  "providerCatalog.envHint": "Normalmente armazenada na variável de ambiente {0}.",
  "providerCatalog.models": "{0} modelos",
  "providerCatalog.docs": "Documentação",
  "providerCatalog.connectSuccess": "Conectado — {0} modelos disponíveis.",
  "providerCatalog.connectError": "Não foi possível conectar: {0}",
  "providerCatalog.loading": "Carregando catálogo…",
  "providerCatalog.loadError": "Não foi possível carregar o catálogo de provedores.",
  "providerCatalog.retry": "Tentar novamente",
  "providerCatalog.empty": "Nenhum provedor corresponde à busca.",
  // Seletor de modelos com busca
  "modelSelect.search": "Buscar modelos…",
  "modelSelect.empty": "Nenhum modelo corresponde à busca.",
  ...
  "theme.claudinio-light": "Claudinio Claro",
  "theme.claudinio-sepia": "Claudinio Sépia",
  ...
  "theme.gruvbox-dark": "Gruvbox Escuro",
