...
const dict: LocaleDict = {
  ...
  "git.edit": "Editar",
  "git.discardConfirm": "Descartar alterações em {0}? Isto não pode ser desfeito.",
  "git.stageAll": "Stage Tudo",
  "git.unstageAll": "Unstage Tudo",
  "git.commitAll": "Commit Tudo",
  "git.commitStaged": "Commit Apenas Staged",
  "git.staged": "Staged",
  "git.unstaged": "Não staged",
  "git.stagedCount": "{0} arquivos staged",
  "git.commitAllDesc": "Stage de tudo e commit",
  "git.commitStagedDesc": "Commit apenas do que está staged",
  "git.noStaged": "Nenhum arquivo staged",
  "git.pushFailRetry": "Push falhou, fazendo pull e tentando novamente...",
  "git.stageFile": "Stage Ficheiro",
  "git.unstageFile": "Unstage Ficheiro",
