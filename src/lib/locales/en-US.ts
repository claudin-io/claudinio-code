...
const dict: LocaleDict = {
  ...
  "net.title": "Network activity",
  "net.idle": "No network activity",
  "net.lastOp": "Last: {0}",
  "net.source.llm_stream": "Model response",
  "net.why.llm_stream": "Streaming the agent's response from the model API. Runs until the turn finishes — including golden-loop cycles and subagents.",
  "net.source.llm_classify": "Turn-completion check",
  "net.why.llm_classify": "Small model call that checks whether the agent's reply is really finished.",
  "net.source.llm_one_shot": "One-off model call",
  "net.why.llm_one_shot": "Single non-streaming model request (enhancement, compaction, evaluation).",
  "net.source.list_models": "Model list",
  "net.why.list_models": "Fetching the list of available models from the API.",
  "net.source.auth": "Authentication",
  "net.why.auth": "Signing in or validating your API key.",
  "net.source.provider_catalog": "Provider catalog",
  "net.why.provider_catalog": "Fetching the models.dev provider catalog.",
  "net.source.skills_index": "Skills registry",
  "net.why.skills_index": "Fetching the remote skills index.",
  "net.source.skill_fetch": "Skill download",
  "net.why.skill_fetch": "Downloading a skill definition.",
  "net.source.embedding_model_download": "Embedding model download",
  "net.why.embedding_model_download": "Downloading the local semantic-search model (only when it's not cached yet).",
  "net.source.web_search": "Web search",
  "net.why.web_search": "The agent is running a web search.",
  ...
  "chat.reconnecting.banner": "Connection lost — retrying in {2}s (attempt {0} of {1})",
  ...
  "chat.message.renderError": "This message couldn't be displayed",
  ...
  "settings.providers.openrouterDesc": "Access hundreds of models through one account, via OAuth.",
  ...
  "providerCatalog.pickProvider": "Pick a provider from the list to connect it.",
  "providerCatalog.apiKey": "API key",
  "providerCatalog.apiKeyPlaceholder": "Paste your API key",
  "providerCatalog.baseUrl": "Base URL",
  "providerCatalog.envHint": "Usually stored in the {0} environment variable.",
  "providerCatalog.models": "{0} models",
  "providerCatalog.docs": "Documentation",
  "providerCatalog.connectSuccess": "Connected — {0} models available.",
  "providerCatalog.connectError": "Could not connect: {0}",
  "providerCatalog.loading": "Loading catalog…",
  "providerCatalog.loadError": "Could not load the provider catalog.",
  "providerCatalog.retry": "Retry",
  "providerCatalog.empty": "No providers match your search.",
  // Searchable model picker
  "modelSelect.search": "Search models…",
  "modelSelect.empty": "No models match your search.",
