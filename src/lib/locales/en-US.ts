...
const dict: LocaleDict = {
  ...
  "git.discard": "Discard",
  "git.edit": "Edit",
  "git.discardConfirm": "Discard changes to {0}? This cannot be undone.",
  ...
  "git.commitAllDesc": "Stage all changes and commit",
  "git.commitStagedDesc": "Commit only staged changes",
  "git.noStaged": "No staged changes",
  "git.pushFailRetry": "Push failed, pulling and retrying...",
